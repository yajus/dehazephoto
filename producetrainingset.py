...
for filename in namen:
    ...
    # 保存：
    #训练前图片
    scipy.misc.imsave('./trainphotoorigin/' + str(indexnum) + '.png', originphoto)
    scipy.misc.imsave('./res/aaaa.png', originphoto)
    #训练后图片
    scipy.misc.imsave('./trainphotodehaze/' + str(indexnum) + '.png', GTimg)
